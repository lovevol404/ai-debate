"""Migration script to add task_config column to debate_topics table."""
import sqlite3
import os
...
def migrate():
    ...
    if "task_config" in columns:
        print("Column 'task_config' already exists. Migration not needed.")
    else:
        cursor.execute("ALTER TABLE debate_topics ADD COLUMN task_config TEXT")
        conn.commit()
        print("Successfully added 'task_config' column to debate_topics table.")
